...
\begin{document}
	...
	\begin{description}
		\item[\href{https://github.com/collabbots}{CollabBots}:] {\footnotesize 
			A robotic system consisting of 2 robotic arms, built from scratch, that use visual-servoing to collaboratively pick-up and stack blocks to make a structure. The sub-modules are partially complete and are under development.
		}
