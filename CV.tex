...
\begin{document}
	...
	\begin{itemize}
		\item[]
			...
			{ \footnotesize
				\begin{itemize}
					\resitem{Synchronizing system clock, cameras, LIDAR, \& GPS using chrony NTP with PPS signals received over RS232}
			...
			\ressubsubheading{Planning and Controls Team Member}{Aug. '19 -- Present}
				...
				\begin{itemize}
					...
					\resitem{Learning about model predictive controller (MPC) to update current implementation for new requirements}
				\end{itemize}
				}
	...
	\begin{description}
		\item[\href{https://github.com/collabbots}{CollabBots}:] {\footnotesize 
			A robotic system consisting of 2 robotic arms, built from scratch, that uses visual-servoing to collaboratively pick-up and stack blocks to make a structure. The sub-modules are partially complete and are under development.
		}
